...
function [svm1, svm2, svm3, svm4] = train_SVMs(target, data)
    ...
    svm1 = svmtrain(target_1, data, '-s 0 -t 2 -b 1 -q');
    ...
    svm2 = svmtrain(target_2, data, '-s 0 -t 2 -b 1 -q');
    ...
    svm3 = svmtrain(target_3, data, '-s 0 -t 2 -b 1 -q');
    
    % Train the fourth SVM
    target_4 = target;
    target_4(target_4 < 4) = 0;
    target_4(target_4 == 4) = 1;
    svm4 = svmtrain(target_4, data, '-s 0 -t 2 -b 1 -q');
